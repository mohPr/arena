...
AGENT = sys.argv[2] if len(sys.argv) > 2 else '/home/moh/Desktop/glm2/result/new_agent/agent.py'
sys.path.insert(0, '/home/moh/Desktop/glm2/result/new_agent')
...
nsO = harness.load('/home/moh/Desktop/glm2/result/v77-pack/opp_pipe19.py', 'opp')
...
while not env.done:
    ...
    try: r0 = a0(o0, None)
    except Exception: r0 = {'farmer': ['PASS'], 'hands': [], 'market': []}
    try: r1 = a1(o1, None)
    except Exception: r1 = {'farmer': ['PASS'], 'hands': [], 'market': []}
    dy = o1.day
    if dy != day:
        day = dy
        f1 = o1.farms[1]
